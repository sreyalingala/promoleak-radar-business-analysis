...
| R-04 | **Alert fatigue**, too many flags, so the team mutes alerts or ignores queue. | Med | High | Start with fewer triggers; tune weekly in pilot. |
...
| R-06 | **Key engineer** unavailable during discovery, leaving gaps in as-is technical truth. | Med | Med | Book Eng Lead early; written follow-ups to understudies. |
